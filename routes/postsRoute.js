...
//         }
//         Post.findOneAndUpdate({id:req.params.id},updatedPost,function(err){
//             if(err){
//                 return resp.send(err);
//             }
//             else{
//                 return resp.send(`Post ${req.body.username} was updated!`);
//             }
//         })
//     });
//
...
//             }
//             else{
//                 return resp.send(`Post ${req.body.username} was deleted!`);
//             }
//         })
//     });
